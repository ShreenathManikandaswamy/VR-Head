...
public class NetManager : Photon.MonoBehaviour
{
    ...
    public void spawnPlayer()
    {
        ...
        GameObject o = PhotonNetwork.Instantiate(avatarprefab[PhotonNetwork.otherPlayers.Length].name, spawnPoints[PhotonNetwork.otherPlayers.Length].position, Quaternion.identity, 0);
